...
public class EmployeeBaseDbTest {
    ...
    private static final String DB_TEST_DATA_PATH = "src/test/resources/testdata/db/%s".replace("/", File.separator);

    protected void init() {
        List<DepartmentEntity> departments = readListFromJson(String.format(DB_TEST_DATA_PATH, "TestDepartments.json"),
                DepartmentEntity.class);
        List<EmployeeEntity> employees = readListFromJson(String.format(DB_TEST_DATA_PATH, "TestEmployees.json"),
